      ...
      <main>
        <div className="flex flex-col justify-around h-[100vh] md:h-[80vh] w-full">
          <div className="flex-wrap">
            ...
            <h1 className='font-syne text-center sm:text-left  text-4xl leading-tight font-medium '>A Software Engineer and a lover of music🎧 & chocolate 🍰</h1>
          </div>
          <div className="socials inline-flex justify-between lg:w-1/2 md:w-full w-full lg:h-20 h-16">
            <div className="github h-full w-20 ">
              <svg xmlns="http://www.w3.org/2000/svg" width="5.2rem" height="5.2rem" viewBox="0 0 48 48">
