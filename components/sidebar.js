...
export default function Sidebar({ currentPage }) {
    ...
    const OpenMenuIcon = () => (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor'" className="size-8 text-primary transition duration-500 ease-in active:rotate-90">
    ...
    const CloseMenuIcon = () => (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor'" className="size-8 transition duration-500 ease-in active:-rotate-90">
    ...
    return (
        <div>
            <button type='button' onClick={() => setIsOpen(!isOpen)} className={`md:hidden absolute translate-x-[77vw] translate-y-[30vh]  ${isOpen ? 'transition-transform ease-in translate-x-[-0rem]' : ' '} rounded-full shadow-2xl  p-4 hover:scale-150`}>
   ...
   duration-500 ease-in-out ${isOpen ? 'block w-[80vw]' : 'translate-x-full'} md:translate-x-0 flex p-9 pt-20 pb-20 justify-center`}>
                <div className='border-4 border-t-white border-r-primary border-b-primary overflow-visible flex z-0'>
                    ...
                    <div className="text-center self-center p-2 z-20">
                        ...
                        <Link href="/contact">
                            <button className={`${getButtonBackgroundClass('/homer')} p-3 rounded-md mb-2 px-9 w-full`} onClick={() => setIsOpen(!isOpen)}>
                                contact
                            </button>
                        </Link>
                    </div>
